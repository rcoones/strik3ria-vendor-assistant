...
localization.settings = {
    text = {
        ...
        frFR = "Réparations de guilde activées",
        deDE = "Gildenreparaturen aktiviert",
        itIT = "Riparazioni di gilda abilitate",
        koKR = "길드 수리 가능",
        zhCN = "启用公会维修",
        zhTW = "啟用公會維修",
        ruRU = "Гильдейский ремонт включен",
    ...
    tooltip = {
        enUS = "Enable guild repairs, if available",
        enGB = "Enable guild repairs, if available",
        frFR = "Activer les réparations de guilde, si disponibles",
        deDE = "Aktivieren Sie Gildenreparaturen, falls verfügbar",
        itIT = "Abilita le riparazioni della gilda, se disponibili",
        koKR = "가능한 경우 길드 수리 활성화",
        zhCN = "启用公会维修（如果可用）",
        zhTW = "啟用公會維修（如果可用）",
        ruRU = "Включить ремонт гильдии, если он доступен",
        esES = "Habilitar las reparaciones del gremio, si están disponibles",
        esMX = "Habilitar las reparaciones del gremio, si están disponibles",
        ptBR = "Habilitar reparos de guilda, se disponível",
    }
}
